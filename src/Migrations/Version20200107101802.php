 ...
 */
final class Version20200107101802 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD roles JSON NOT NULL, DROP firstname, DROP lastname, DROP phone, DROP role, DROP created_at, CHANGE email email VARCHAR(180) NOT NULL');
